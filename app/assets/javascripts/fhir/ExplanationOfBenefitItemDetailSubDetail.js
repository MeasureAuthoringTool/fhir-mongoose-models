...
ExplanationOfBenefitItemDetailSubDetailSchema.add(BackboneElementSchema);
ExplanationOfBenefitItemDetailSubDetailSchema.remove('id');
ExplanationOfBenefitItemDetailSubDetailSchema.add({
