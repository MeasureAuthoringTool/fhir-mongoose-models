...
const TaskInputSchema = BackboneElementSchemaFunction({
  ...
  typeName: { type: String, default: 'TaskInput' },
  _type: { type: String, default: 'FHIR::TaskInput' },
});

class TaskInput extends mongoose.Document {
  constructor(object) {
    super(object, TaskInputSchema);
    this.typeName = 'TaskInput';
    this._type = 'FHIR::TaskInput';
  }
}

module.exports.TaskInputSchema = TaskInputSchema;
