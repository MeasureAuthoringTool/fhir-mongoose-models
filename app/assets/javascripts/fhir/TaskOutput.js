...
const TaskOutputSchema = BackboneElementSchemaFunction({
  ...
  typeName: { type: String, default: 'TaskOutput' },
  _type: { type: String, default: 'FHIR::TaskOutput' },
});

class TaskOutput extends mongoose.Document {
  constructor(object) {
    super(object, TaskOutputSchema);
    this.typeName = 'TaskOutput';
    this._type = 'FHIR::TaskOutput';
  }
}

module.exports.TaskOutputSchema = TaskOutputSchema;
module.exports.TaskOutput = TaskOutput;
